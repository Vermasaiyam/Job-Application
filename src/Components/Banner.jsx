    ...
    <div>
      <div className='flex flex-row flex-wrap h-96  mx-32 py-3 gap-5 justify-center mt-10     '>
            <div className='  h-[100%] w-[30%] flex flex-col justify-center items-center gap-2'>
                ...
                <div>
                    <h1 className='text-md'>Free Delivery for all orders over $140</h1>
                </div>
            </div>
            <div className='  h-[100%] w-[30%] flex flex-col justify-center items-center gap-2'>
                <div className='p-5 flex justify-center'>
                ...
                <div>
                    <h1 className='text-md'>Friendly 24/7 Customer Support</h1>
                </div>
            </div>
            <div className='  h-[100%] w-[30%] flex flex-col justify-center items-center gap-2'>
                <div className='p-5 flex justify-center'>
                ...
                <div>
                    <h1 className='text-md'>We return money within 30 days</h1>
                </div>
            </div>
