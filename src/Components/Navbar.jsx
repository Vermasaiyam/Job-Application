...
<form className="flex items-center max-w-sm mx-auto">   
    ...
    <div className='mx-2'>
    <a href=""><img src={heart} alt="" style={{height:"30px" , width:"45px" , padding:"2px"}} className=''/></a>
    </div>
    <div>
  ...
  <div className="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
    <ul className="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white ">
      ...
      <li>
        <a href="#" className="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 " >Sign Up</a>
      </li>
    </ul>
  </div>
  </div>
